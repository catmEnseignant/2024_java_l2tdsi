...
La méthode aboyer() n'existe pas dans la classe Animal, donc l'appel à aboyer() sur une référence de type Animal (même si elle pointe vers un objet de type Chien) provoque une erreur de compilation.
Ce texte explique pourquoi l'appel à la méthode aboyer() n'est pas possible sur une référence de type Animal.
        */
    }
}
